...
def get_fee_for_payment_method(method: str) -> dict:
    ...
    fee_database = {
        ...
        "gold credit card": 0.01,
        "silver credit card": 0.005,
        "platinum debit card": 0.02,
        "gold debit card": 0.01,
        "silver debit card": 0.005,
        "bank transfer": 0.01,
    }
    ...
    if fee is not None:
        ...
        return {"status": "error", "error_message": "Payment method {method} not found"}
...
enhanced_currency_agent_runner = InMemoryRunner(agent=enhanced_currency_agent)
response = asyncio.run(enhanced_currency_agent_runner.run_debug(
